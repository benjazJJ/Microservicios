package Microservicio.de.Control.de.roles.y.Permisos.Microservicio.de.roles.y.permisos.Config;
...
public class LoadDatabase {
    @Bean
    CommandLineRunner initDatabase(RoleRepository rolRepo, PermisoRepository permisoRepo) {
        return args -> {
